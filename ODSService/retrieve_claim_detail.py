		...
		try:
			...
			with io.open(oFileName,'a',encoding='utf-8') as o:     
				...
				for clm_id in claim_id_list:
					...
					claimlstStr = claimlstStr + "{\'claimId\':\'"+ clm_id.lstrip() + "\',\'companyId\':\'1\'}"
				claim_id_filter = '[' +claimlstStr+ ']'
				#claim_id_filter = '{\'claimId\':\'28711949\',\'companyId\':\'1\'}'
				...
				payload2 = '{"resultFilter":"claimLossEventInfoList","claimList":"'+claim_id_filter+'"}'
